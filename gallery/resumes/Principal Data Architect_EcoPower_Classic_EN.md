...
MegaConsulting Tech Solutions Ltd., Dec 2022–Present

Keywords: AWS, Azure, Data Architecture, Team Leadership, Cloud Migration

Summary:

- Served as Technical Lead for BioLife Sciences's digital transformation, architecting a unified Customer Data Platform (CDP) integrating 8+ systems and billions of records to enable 360-degree customer analytics.
...
### BioLife Sciences Customer Data Platform (CDP)
